    ...
    appearance: {
      ...
      elements: {
        ...
        socialButtonsBlockButton:
          'bg-[#1a1a1f] hover:bg-[#232329] border border-[#2e2e35] text-gray-200 text-sm font-medium rounded-lg !h-10 transition-colors duration-200',
        socialButtonsBlockButtonText: 'text-gray-200 text-sm font-medium',
        socialButtonsIconButton: 'text-gray-300 !w-5 !h-5',
        formButtonPrimary:
        ...
        footerActionLink: 'text-amber-500 hover:text-amber-400 font-medium transition-colors',
